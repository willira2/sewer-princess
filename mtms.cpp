/*********************************************************************
 ** Program Filename: mtms.cpp
 ** Author: Rachel Williams
 ** Date: 3 - 10 - 16
 ** Description: implementation file for MTMS class
 ** Input: none
 ** Output: none
 *********************************************************************/
...
void MTMS::menu()
{
    ...
    do {
        std::cout << "\nYou're on Mole Town Main Street. What do you want to do?\n";
