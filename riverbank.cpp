/*********************************************************************
 ** Program Filename: riverbank.cpp
 ** Author: Rachel Williams
 ** Date: 3 - 10 - 16
 ** Description: implementation file for RiverBank class
 ** Input: none
 ** Output: none
 *********************************************************************/
...
void RiverBank::menu()
{
    ...
    do {
        std::cout << "\nYou're on the river bank. What do you want to do?\n";
        ...
        switch (choice) {
            ...
            case 1:
                ...
                std::cout << "1 - jump in the river\n";
                std::cout << "2 - go to the palace entrance\n";
                std::cout << "3 - go to the start area\n";
                std::cout << "4 - go to Mole Town Main Street\n";
